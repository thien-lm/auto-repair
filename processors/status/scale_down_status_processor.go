...
type ScaleDownStatusProcessor interface {
	Process(context *context.AutorepairingContext, status *ScaleDownStatus)
	CleanUp()
}
...
func (p *NoOpScaleDownStatusProcessor) Process(context *context.AutorepairingContext, status *ScaleDownStatus) {
}
